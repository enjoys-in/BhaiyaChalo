...
func toDispatchResponse(data interface{}) interface{} {
	// TODO: implement response mapping
	return data
}

func toOfferStatusResponse(data interface{}) interface{} {
	// TODO: implement response mapping
	return data
}

func validateCreateDispatchRequest(v interface{}) error {
