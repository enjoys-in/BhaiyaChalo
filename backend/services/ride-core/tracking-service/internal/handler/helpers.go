...
func toLocationResponse(data interface{}) interface{} {
	// TODO: implement response mapping
	return data
}

func toTrackingSessionResponse(data interface{}) interface{} {
	// TODO: implement response mapping
	return data
}

func validateUpdateLocationRequest(v interface{}) error {
	// TODO: implement validation
	return nil
}

func validateStartTrackingRequest(v interface{}) error {
	// TODO: implement validation
	return nil
}
