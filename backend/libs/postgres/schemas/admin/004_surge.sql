...
CREATE INDEX idx_admin_surge_zones_composite ON public.admin_surge_zones (city_id, geofence_id);

-- Partitioned by calculated_at for time-series queries
...
CREATE TABLE public.admin_surge_history_default
    PARTITION OF public.admin_surge_history DEFAULT;
...
CREATE INDEX idx_admin_surge_history_comp ON public.admin_surge_history (zone_id, calculated_at);
